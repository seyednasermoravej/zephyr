.. zephyr:board:: w6100_evb_pico

Overview
********

W6100-EVB-Pico is a microcontroller evaluation board based on the Raspberry
Pi RP2040 and fully hardwired TCP/IP controller W6100 - and basically works
the same as Raspberry Pi Pico board but with additional Ethernet via W6100.
...
External pin mapping on the W6100_EVB_PICO is identical to the Raspberry Pi
...
Refer to `W6100 Evaluation Board Documentation`_ for a board schematic and
...
.. _W6100 Evaluation Board Documentation:
  https://docs.wiznet.io/Product/Chip/Ethernet/W6100/w6100-evb-pico
